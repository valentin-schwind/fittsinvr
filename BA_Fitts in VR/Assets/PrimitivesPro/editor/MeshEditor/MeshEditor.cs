...
namespace PrimitivesPro.Editor.MeshEditor
{
    ...
    public class MeshEditor : UnityEditor.Editor
    {
        ...
        private void UpdateSceneViewGUI()
        {
            Handles.BeginGUI();
        ...
        private void UpdateMouseEditing()
        {
            if (!editObject)
            {
                return;
        ...
        private void OnMultiselectFinished()
        {
            if (multiselecting)
            {
        ...
        private void UpdateVertexEditing()
        {
        ...
        private void UpdateEdgesEditing()
        {
            var guiEvent = Event.current.type;
