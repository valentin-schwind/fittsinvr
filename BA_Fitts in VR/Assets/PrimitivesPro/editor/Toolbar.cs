...
namespace PrimitivesPro.Editor
{
    public class Toolbar : EditorWindow
    {
        ...
        private void EnableButtons(ToolButton[] buttons, bool enable)
        {
        ...
        private void OnMeshEditorButton(ToolButton cmd)
        {
        ...
        private void OnPrimitivesButton(ToolButton btn)
        {
        ...
        private void OnSystemButton(ToolButton btn)
        {
...
//                    SettingsWindow.Refresh(MeshEditor.MeshEditor.Instance.GetSettings());
        ...
        private void OnEnableMeshEditor()
        {
            if (enableMeshEditor)
            {
