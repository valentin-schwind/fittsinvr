...
public class CP_SSSSS_Main : MonoBehaviour
{
	...
	private RenderTexture sourceBuf;
	private RenderTexture blurBuf;

	private CommandBuffer buffer;
	private CameraEvent camEvent = CameraEvent.BeforeImageEffectsOpaque;
	...
	private Camera maskRenderCamera;
	...
	{
		buffer.Clear();
		var blurRT1 = Shader.PropertyToID("_CPSSSSSBlur1");
		var blurRT2 = Shader.PropertyToID("_CPSSSSSBlur2");
		var src = Shader.PropertyToID("_CPSSSSSSource");
		...
		//multipass pass blur
		for (var k = 1; k <= blurIterations; k++)
		{
